       ...
       <tr >
        ...
        <tr >
            ...
            <td ><input  style="width: 100%;  display: block;" type="text" name="event_buy_tickets_message" value="<?php echo esc_attr($event_buy_tickets_message); ?>" />
				<div style="color: #999999; font-size: 0.9em; margin-left: 5px;"><?php echo esc_html__('ex. [Buy Tickets From] or [Free Entry]','lucille-music-core'); ?></div>
			</td>
        </tr>		
        <tr >
...
function LUCILLE_SWP_jamsession_events_admin_columns_func($columns)
{
	$columns = array(
		...
		'title' => esc_html__('Event Title', 'lucille-music-core'),
