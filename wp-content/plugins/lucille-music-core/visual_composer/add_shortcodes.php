						...
						<a href="<?php echo get_the_permalink(); ?>">
							...
							<div class="event_list_entry event_buy">
								...
								if (!empty($event_buy_tickets_message)) {
									...
									$tickets_buy_html = '<div class="lc_js_link" data-href="'.esc_url($event_final_ticket_url).'" data-target="'.esc_attr($ticket_click_target).'">'.esc_html($event_buy_tickets_message).'</div>';
