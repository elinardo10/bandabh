...
if (function_exists('vc_add_param'))
{
	...
	vc_add_param( "vc_row", array(
		"type"			=> "dropdown",
		"class"			=> "",
		"heading"		=> esc_html__("Boxed Width", "lucille"),
		"param_name"	=> "lc_swp_row_boxed_width",
		"value"			=> array(
						esc_html__("Default", "lucille-music-core")	=> "default",
						esc_html__("Force Boxed", "lucille-music-core")			=> "force_boxed"
						),
		"description"	=> esc_html__("Force boxed width for this row.", "lucille-music-core")
	));	
}
